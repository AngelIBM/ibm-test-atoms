...
/**
 * ================================================================= 
 * Source file taken from :: busyindicator.blackberry10.js
 * ================================================================= 
 */
...
/**
 * busy.js is not running on blackberry. Overriding with simple center text implementation.
 */
...
function getBusyOverlay(parent, overlayOptions, busy) {
	...
	// position the busy in the middle of the parent element, in BB10 we will use the window innerHeight instead of the parent element height.
...
WL.BusyIndicator = WLJSX.Class.create({
	...
	*/
	...
	initialize : function(containerId, options) {
		...
		//For BlackBerry device we need to calculate the position of the busy again on rotation
		window.addEventListener("orientationchange", function (obj) {
			var busy = WLJSX.$("WLbusy");
			var busyWidth = WLJSX.width(busy);
			var busyHeight = WLJSX.height(busy);
			
			WLJSX.css(busy, { 
			    left : window.innerWidth / 2 - busyWidth / 2 + 'px',
			    top : window.innerHeight /2 - busyHeight / 2 + 'px'
			});
		}, true);
	},
...
/**
 * ================================================================= 
 * Source file taken from :: wlgap.blackberry10.js
 * ================================================================= 
 */
...
if (typeof blackberry != "undefined" && blackberry.app && blackberry.app.event) {
