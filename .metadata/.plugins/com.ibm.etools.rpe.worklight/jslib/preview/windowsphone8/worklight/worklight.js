...
/**
 * ================================================================= 
 * Source file taken from :: ExtendedGeolocation.windowsphone8.js
 * ================================================================= 
 */
...
//        options = parseParameters(options); -- unnecessary - done in geo.js
        ...
        // Otherwise we have to call into native to retrieve a position.
            ...
            Cordova.exec(win, fail, "WLGeolocationPlugin", "getLocation", [id,options.enableHighAccuracy, options.maximumAge, options.desiredAccuracy, options.timeout]);
        }
        return timeoutTimer;
    };
...
//       options = parseParameters(options);
        ...
        Cordova.exec(win, fail, "WLGeolocationPlugin", "addWatch", [id, options.maximumAge, options.enableHighAccuracy, options.desiredAccuracy, options.minChangeDistance, options.minChangeTime]);
    ...
    this.clearWatch = function(id) {
        if (id && timers[id] !== undefined) {
            ...
            Cordova.exec(null, null, "WLGeolocationPlugin", "removeRequest", [id]);
            delete timers[id];
        }
    };
...
/**
 * ================================================================= 
 * Source file taken from :: busyindicator.windowsphone8.js
 * ================================================================= 
 */
...
/**
 * ================================================================= 
 * Source file taken from :: wlgap.wp8.js
 * ================================================================= 
 */
...
__WLNativePage = function () {
    ...
    this.show = function (className, callback, data) {
        cordova.exec(callback, callback, "WLNativePage", "show", [className, data]);
    };
};
...
WL.Device.__getPublisherHostID = function(successCallback, failureCallback) {
	cordova.exec(successCallback, failureCallback, "DeviceInfo", "getPublisherHostID", []);
};

WL.Device.getPublisherHostID = function(options){
	WL.Validators.validateArguments([ 'object' ], arguments, 'WL.Device.getPublisherHostID');
	
	WL.Validators.validateOptions({ 
			onSuccess : 'function', 
			onFailure : 'function'
		}, options, 'WL.Device.getPublisherHostID');
	...
	WL.Device.__getPublisherHostID(successCallback, options.onFailure);
};
...
__WLPush = function() {
    ...
    this.__dispatchPendings = function () {
        ...
        for (var eventsCounter in pendindPushEventsArray) {
            var pendindPushEvent = pendindPushEventsArray[eventsCounter]; 
...
/**
 * ================================================================= 
 * Source file taken from :: wlgap.wp8.preview.js
 * ================================================================= 
 */
...
/**
 * OptionsMenu API for the WP Preview Environment.
 */

window.alert = window.webAlert;
...
WL.App.getServerUrl = function(successCallback, failCallback) {
	...
	var serverUrl = window.document.location.protocol + '//'
			+ window.document.location.host + '/'
			+ window.document.location.pathname.split('/')[1] + '/';
	successCallback(serverUrl);
