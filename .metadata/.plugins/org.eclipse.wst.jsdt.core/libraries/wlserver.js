 ...
 * 				</ul>
 * 			</li>
 * 			<li>Accessing user and device details.<br />
 * 				<ul>
 * 					<li>WL.Server.getActiveUser</li>
 * 					<li>WL.Server.setActiveUser</li>
 * 					<li>WL.Server.getCurrentUserIdentity</li>
 * 					<li>WL.Server.getCurrentDeviceIdentity</li>
 * 				</ul>
 * 			</li>
 ...
 * 				<ul>
 * 					<li>WL.Server.logActivity. Deprecated.</li>
 ...
 * 				</ul>
 * 			</li>
 * 			<li>Getting beacons, triggers and their associations<br />
 * 				<ul>
 * 					<li>WL.Server.getBeaconsAndTriggers</li>
 * 				</ul>
 * 			</li>
 * 		</ul>
 * 	</dd>
...
__WLServer = function() {
	 ...
	 * 			</table>
	 * @example 
	 * WL.Server.addResponseHeader("Expires","Sun, 5 October 2014 18:00:00 GMT");
	 * @methodOf WL.Server#
	 */
	this.addResponseHeader = function(input) {
	};
	 ...
	 *            <dl class="detailList">
   *						<dt class="heading">Special values for this parameter:</dt>
	 *						  <dd><b>0</b> for wait indefinitely.</dd>
	 *							<dd><b>&lt;0</b> for do not wait.</dd>
	 *						</dl>
	 * 				</td>
	 * 			  </tr>
	 * 			  <tr>
   ...
   *						<dt class="heading">Special values for this parameter:</dt>
	 ...
	 * @description Returns an object with the user identity properties, if a realm is defined on the adapter<br />
	 * 			<ul>
	 ...
	 * @methodOf WL.Server#
	 */
	this.getCurrentUserIdentity = function() {
	};
	
	/**
	 * Returns an object with the device identity properties .
	 * @description Returns an object with the device identity properties, if a realm is defined on the adapter<br />
	 * 			<ul>
	 * 				<li>If there is no device identity associated with the device, the method returns <code>null</code>.</li>
 	 * 				<li>If there is a device identity associated with the device , the method returns the device identity.</li>
	 * 			</ul>
	 *
	 * @returns An object with the device identity properties, as defined by the
	 *         login module, with the following structure:
	 * <p>
	 * <ul>
	 * <li>deviceId - The login ID, mandatory. </li>
	 * <li>displayName - Optional. </li> 
	 * <li>attributes - Optional. Custom user attributes. There are no constraints on the structure of the object.</li>
	 * </ul>
	 * </p>
	 * @example 
	 * {
	 * 	deviceId: "38017840288"
	 * 	displayName: "John Doe",
	 * 	attributes: {lastLogin: "2010-07-13 19:25:08.0 GMT"}
	 * }
	 * @methodOf WL.Server#
	 */
	this.getCurrentDeviceIdentity = function() {
	};
	 ...
	 * <h3 class="heading"><b> Parameters for IBM Worklight V5.0.5 and earlier</b> </h3>
	 ...
	 * 					<dd>Optional. The name of a file to play when the notification arrives. No sound will be played if the file does not exist or if the value is empty. If this property is not set, default notification ringtone will be played.</dd>
	 * 			</dl>
	 * 			<dl class="detailList">
	 ...
	 * 						<dd>Optional. A string representing the type of notification. One of DEFAULT (also the default when not specified), SILENT and MIXED</dd>
	 * 					</dl>
	 * 					<dl class="detailList">
	 * 						<dt class="heading">alert</dt>
	 * 						<dd>Optional. A string to be displayed in the alert.</dd>
	 ...
	 * 						<dd>Optional. Name of the category for iOS8 interactive push notifications.</dd>
	 * 					</dl>
	 * 					<dl class="detailList">
	 ...
	 * 					</dl>
	 * 	 				<dl class="detailList">
	 * 						<dt class="heading">priority</dt>
	 * 						<dd>Optional. A string value that indicates the priority of this notification. Allowed values are 'max', 'high', 'default', 'low' and 'min'. High/Max priority notifications along with 'sound' field may be used for Heads up notification in Android 5.0 or higher.</dd>
	 * 					</dl>
	 * 	 				<dl class="detailList">
	 * 						<dt class="heading">visibility</dt>
	 * 						<dd>Optional. A string value that indicates the visibility level of notification content on the secured lock screen in Android L devices. Allowed values are 'public, 'private' and 'secret'. Only applies to Android 5.0 or higher.</dd>
	 * 					</dl>
	 * 	 				<dl class="detailList">
	 * 						<dt class="heading">redact</dt>
	 * 						<dd>Optional. A string to be displayed in the alert as a redacted version of the original content when the visibility level is 'private'. Only applies to Android 5.0 or higher.</dd>
	 * 					</dl>
	 * 	 				<dl class="detailList">
	 * 						<dt class="heading">category</dt>
	 * 						<dd>Optional. A string value that indicates the category to which this notification belongs. Allowed values are 'call', 'alarm', 'email', 'err', 'event', 'msg', 'progress', 'promo', 'recommendation', 'service', 'social', 'status', and 'transport'. Only applies to Android 5.0 or higher.</dd>
	 * 					</dl>
	 * 	 				<dl class="detailList">
	 * 						<dt class="heading">bridge</dt>
	 * 						<dd>Optional. A Boolean value that indicates whether the notification should be bridged or not to other devices connected to this handheld device. Only applies to Android 5.0 or higher.</dd>
	 * 					</dl>
	 * 	 				<dl class="detailList">
	 * 						<dt class="heading">sync</dt>
	 * 						<dd>Optional. A Boolean value that indicates whether the notification should be sync'd between devices of the same user, that is, if a notification is handled on a device it gets dismissed on the other devices of the same user. Only applies if Google Play Services library is added to the Android project.</dd>
	 * 					</dl>
	 * 					<dl class="detailList">
	 * 						<dt class="heading">collapseKey</dt>
	 * 						<dd>Optional. A string value that indicates that the message can be replaced. When multiple messages are queued up in GCM Servers with the same key, only the last one is delivered.</dd>
	 * 					</dl>
	 * 				</dd>
	 * 		</dl>
	 * 		<dl class="detailList">
	 ...
	 * 		</dl>
	 * 		<dl class="detailList">
	 * 				<dt class="heading">WNS</dt>
	 * 				<dd>
	 * 					Following WNS settings are derived from the XML schema of each notification type as specified in Microsoft documentation. For detailed information on below attributes, refer to Microsoft documentation on Tile, Toast and Badge schemas. 
	 * 					<dl class="detailList">
	 * 						<dt class="heading">expirationTime</dt>
	 * 						<dd>Optional. Expriry time of the notification.</dd>
	 * 					</dl>
	 * 					<dl class="detailList">
	 * 						<dt class="heading">cachePolicy</dt>
	 * 						<dd>Optional. A boolean value that indicates if the notification should be cached or not.</dd>
	 * 					</dl>
	 * 					<dl class="detailList">
	 * 						<dt class="heading">raw</dt>
	 * 						<dd>
	 ...
	 * 							</dl>
	 * 							<dl class="detailList">
	 * 								<dt class="heading">audio</dt>
	 * 								<dd>
	 * 									<dl class="detailList">
	 * 										<dt class="heading">src</dt>
	 * 										<dd>Optional. A string value that specifies the notification sound type.</dd>
	 * 									</dl>
	 * 									<dl class="detailList">
	 * 										<dt class="heading">loop</dt>
	 * 										<dd>Optional.  A boolean value to indicate if the sound should be repeated or not.</dd>
	 * 									</dl>
	 * 									<dl class="detailList">
	 * 										<dt class="heading">silent</dt>
	 * 										<dd>Optional. A boolean value to indicate if the sound should be played or not.</dd>
	 * 									</dl>
	 * 								</dd>
	 * 							</dl>
	 * 							<dl class="detailList">
	 * 								<dt class="heading">visual</dt>
	 * 								<dd>
	 * 									<dl class="detailList">
	 * 										<dt class="heading">version</dt>
	 * 										<dd>Optional. Version of the payload.</dd>
	 ...
	 * 									</dl>
	 * 									<dl class="detailList">
	 * 										<dt class="heading">contentId</dt>
	 * 										<dd>Optional. A string value that identifies the notification content.</dd>
	 * 									</dl>
	 * 									<dl class="detailList">
	 * 										<dt class="heading">binding</dt>
	 * 										<dd>
	 * 											A JSON array containing JSON blocks of following binding attributes.
	 * 											<dl class="detailList">
	 * 												<dt class="heading">template</dt>
	 * 												<dd>Mandatory. Template type of the toast notification.</dd>
	 * 											</dl>
	 ...
	 * @note {Note} 
	 * 			<ul>
	 * 				<li>If a notification to a specific Windows Phone 8 device subscription fails, the notification is not resubmitted.</li>
	 ...
	 * // change the toast attributes for WNS
	 * notification.WNS.toast.visual.binding.template = "ToastText04";
	 * notification.WNS.toast.visual.binding.text =[{"content":"Text1"},{"content":"Text2"},{"content":"Text3"}];
	 *
	 ...
	 * 														<dl class="detailList">
	 * 															<dt class="heading">content</dt>
	 * 															<dd>Mandatory. A string value that is displayed in the tile.</dd>
	 * 														</dl>
	 * 													</dd> 
	 * 												</dl>
	 * 											</dd>
	 ...
	 * notification.settings.wns = {};
	 * notification.settings.wns.raw = {};
	 * notification.settings.wns.raw.payload = {"custom":"data"}
	 * 
	 * // set toast notification properties for WNS
	 * notification.settings.wns.toast = {};
	 * notification.settings.wns.toast.launch = {"custom":"data"}
	 * notification.settings.wns.toast.visual = {};
	 * notification.settings.wns.toast.visual.binding = {};
	 * notification.settings.wns.toast.visual.binding.template="ToastText04";
	 * notification.settings.wns.toast.visual.binding.text=[{"content":"Text1"},{"content":"Text2"},{"content":"Text3"}];
	 * 
	 * // set tile notification properties for WNS
	 * notification.settings.wns.tile = {};
	 * notification.settings.wns.tile.visual = {};
	 * notification.settings.wns.tile.visual.binding=[{"template":"TileSquareText04", "text": [{"content":"Text1"}]}, {"template":"TileWideText04","text": [{"content":"Text1"}]}];
	 * 
	 * // set badge notification properties for WNS
	 * notification.settings.wns.badge = {};
	 * notification.settings.wns.badge.value = 10; 
	 * 
	 ...
	 * 		<ul>
	 * 			<li>Push notifications on iOS, Android, Windows Phone 8 and Windows 8</li>
	 * 			<li>SMS push notifications on iOS, Android, Windows Phone 8, and BlackBerry devices that support SMS functions</li>
	 * 		</ul>

	 * @param notificationText Optional. The string that is displayed in the alert. On Windows Phone 8 the string is displayed in the application tile title. On Windows 8 the string is displayed as tile and toast text.
	 ...
	 * 				  or if the application is already open. On Windows Phone 8 and Windows 8, the payload is transferred to the application as a raw notification only if the application is already open.
	 *
	 ...
	 *			binding:[
	 *				{
	 *					template: "TileSquare150x150Text04",
	 ...
	 *				},
	 *           	{
	 *	      	 		template: "TileWide310x150Text04",
	 ...
	 *				},
     *          	{
	 *        			template: "TileSquare310x310Text01",
	 *					text:[
     *			 	   		{						        
	 *			   	   			content: notificationText
	 *						}
	 ...
	 *	 }
	 *	}
	 * @note {Note}  Version 2 notification template along with a fallback template is returned for Windows 8 tile notification. 
	...
	*}
	...
	/**
	 * Returns the String value of the ClientID associated with this client.   
	 * @returns <code>String</code> value of a unique ClientID, or null if this client has not been registered
	 * @methodOf WL.Server#
	 */
	...
	/**
	 * Retrieves <i>relevant</i> beacons and triggers along with their associations for the specified application.<br />
	 * 
	 * @description A beacon/trigger is considered to be <i>relevant</i> for this application if there is at least one 
	 *              trigger/beacon associated with it in this application.
	 * 
	 * @param  applicationName Mandatory. The name of the MobileFirst application.
	 * @param  beaconsOfInterest Optional. A JSON block or an array of JSON blocks identifying the beacon/s whose 
	 *         trigger associations have to be fetched.
	 * <ul>
	 *    <li>If this parameter is specified as <i>null</i>, then all relevant beacons, triggers, and their 
	 *        associations will be returned.
	 *    </li>
	 *    <li>If this parameter is specified as a JSON block that contains only the <i>uuid</i>, then the triggers 
	 *        and associations of all relevant beacons with matching <i>uuid</i> will be returned.
	 *    </li>
	 *    <li>If this parameter is specified as a JSON block that contains only the <i>uuid</i> and <i>major</i>, then the triggers 
	 *        and associations of all relevant beacons with matching <i>uuid</i> and <i>major</i> will be returned.
	 *    </li>
	 *    <li>If this parameter is specified as a JSON block that contains only the <i>uuid</i> and <i>minor</i>, then the triggers 
	 *        and associations of all relevant beacons with matching <i>uuid</i> and <i>minor</i> will be returned.
	 *    </li>
	 *    <li>If this parameter is specified as a JSON block that contains <i>uuid</i>, <i>major</i>, and <i>minor</i>, then the relevant 
	 *        triggers and associations of that specific beacon will be returned.
	 *    </li>
	 *    <li>If this parameter is specified as an array of JSON blocks that identifies a set of beacons with <i>uuid</i> or 
	 *        <i>uuid+major</i> or <i>uuid+minor</i> or <i>uuid+major+minor</i> then the relevant triggers and 
	 *        associations of that specific set of beacons will be returned.
	 *    </li>
	 * </ul>
	 * 
	 * <br /><br />Examples:<br />
	 * a) Gets all relevant beacons, triggers, and associations
	 * <pre class="code">
	 * WL.Server.getBeaconsAndTriggers("Application1", null);
	 * </pre>
	 * 
	 * b) Gets all relevant beacons with matching UUID, relevant triggers, and associations
	 * <pre class="code">
	 * WL.Server.getBeaconsAndTriggers("Application1", {
	 *    "uuid": "3d402cf0-3691-4bd9-97ff-0b0a93a160ef"
	 * });
	 * </pre>
	 * 
	 * c) Gets all relevant beacons with matching UUID and major, relevant triggers, and associations
	 * <pre class="code">
	 * WL.Server.getBeaconsAndTriggers("Application1", {
	 *    "uuid": "3d402cf0-3691-4bd9-97ff-0b0a93a160ef",
	 *    "major": 1
	 ...
	 * </pre>
	 * 
	 * d) Gets all relevant beacons with matching UUID and minor, relevant triggers, and associations
	 * <pre class="code">
	 * WL.Server.getBeaconsAndTriggers("Application1", {
	 *    "uuid": "3d402cf0-3691-4bd9-97ff-0b0a93a160ef",
	 *    "minor": 4417
	 ...
	 * </pre>
	 * 
	 * e) Gets relevant triggers and associations of a specific beacon
	 * <pre class="code">
	 * WL.Server.getBeaconsAndTriggers("Application1", {
	 *    "uuid": "3d402cf0-3691-4bd9-97ff-0b0a93a160ef",
	 *    "major": 1,
	 ...
	 * </pre>
	 * 
	 * f) Gets relevant triggers and associations of a specific set of beacons
	 * <pre class="code">
	 * WL.Server.getBeaconsAndTriggers("Application1", [
	 *    {
	 *       "uuid": "3d402cf0-3691-4bd9-97ff-0b0a93a160ef",
	 ...
	 * </pre>
	 * 
	 * g) Gets all relevant beacons with matching UUID and any of the specified minor, relevant triggers, and associations
	 * <pre class="code">
	 * WL.Server.getBeaconsAndTriggers("Application1", [
	 *    {
	 *       "uuid": "3d402cf0-3691-4bd9-97ff-0b0a93a160ef",
	 ...
	 * </pre>
	 * 
	 * h) Gets all relevant beacons with matching UUID and any of the specified major/minor, relevant triggers, and associations
	 * <pre class="code">
	 * WL.Server.getBeaconsAndTriggers("Application1", [
	 *    {
	 *       "uuid": "3d402cf0-3691-4bd9-97ff-0b0a93a160ef",
	 ...
	 * </pre>
	 * 
	 * @returns This method returns a JSON block that contains the lists of relevant beacons, relevant triggers, and associations.
	 * 
	 * <br>The returned object has the following structure:
	 * <pre class="code">
	 * {
	 ...
	 *          "proximityState": "Near",
	 *          "actionPayload": {
	 *             "alert": "Hi $userName. Welcome to $branchName branch of ABC bank."
	 *          }
	 *       },
	 *       ...
	 *       {
	 ...
	 *          "dwellingTime": 5000,
	 *          "actionPayload": {
	 *             "adapterCallback": "customerDwellInsideLoanSection"
	 *          }
	 *       }
	 *    ],
	 ...
	 * </pre>
	 * 
	 * The JSON block inside <i>beacons</i> array contains the following properties:<br />
	 * <table border="1">
	 *    <tr>
	 *       <th><b>Property</b></th>
	 *       <th><b>Description</b></th>
	 ...
	 *    <tr>
	 *       <td>uuid</td>
	 *       <td>UUID of beacon.</td>
	 *    </tr>
	 *    <tr>
	 *       <td>major</td>
	 *       <td>Major number of beacon.</td>
	 *    </tr>
	 *    <tr>
	 *       <td>minor</td>
	 *       <td>Minor number of beacon.</td>
	 *    </tr>
	 *    <tr>
	 *       <td>latitude</td>
	 *       <td>Optional latitude where beacon is deployed.</td>
	 *    </tr>
	 *    <tr>
	 *       <td>longitude</td>
	 *       <td>Optional longitude where beacon is deployed.</td>
	 *    </tr>
	 *    <tr>
	 *       <td>customData</td>
	 *       <td>Any other customer-specific data that is associated with this 
	 *           beacon like branch/store where this beacon is deployed.
	 *       </td>
	 *    </tr>
	 * </table>
	 * 
	 * <br />
	 * The JSON block inside <i>beaconTriggers</i> array contains the following properties:<br />
	 * <table border="1">
	 *    <tr>
	 *       <th><b>Property</b></th>
	 *       <th><b>Description</b></th>
	 ...
	 *    <tr>
	 *       <td>triggerName</td>
	 *       <td>Unique name for the beacon-trigger</td>
	 *    </tr>
	 *    <tr>
	 *       <td>triggerType</td>
	 *       <td>Takes one of following values:
	 *          <ul>
	 *             <li>Enter: This trigger will be activated when the device enters the associated beacon region.</li>
	 *             <li>Exit: This trigger will be activated when the device leaves the associated beacon region.</li>
	 *             <li>DwellInside: This trigger will be activated when the device remains inside the associated 
	 *                 beacon region for a given time period (specified by dwellingTime).
	 *             </li>
	 *             <li>DwellOutside: This trigger will be activated when the device remains outside the associated 
	 *                 beacon region for a given time period (specified by dwellingTime).
	 *             </li>
	 *          </ul>
	 *       </td>
	 *    </tr>
	 *    <tr>
	 *       <td>proximityState</td>
	 *       <td>Takes one of following values:
	 *          <ul>
	 *             <li>Immediate: The proximity of the device to the associated beacon region must be "immediate" 
	 *                 (physically very close) for the trigger to be activated.
	 *             </li>
	 *             <li>Near: The proximity of the device to the associated beacon region must be at least "near" 
	 *                 (approximately 1-3 meters) for the trigger to be activated.
	 *             </li>
	 *             <li>Far: The proximity of the device to the associated beacon region must be at least "far" 
	 ...
	 *    <tr>
	 *       <td>dwellingTime</td>
	 *       <td>Present only for triggerTypes: "DwellInside" and "DwellOutside". 
	 *           It specifies the time in milliseconds for how long the device must be inside or outside the 
	 *           associated beacon region before the dwellInside or dwellOutside trigger is activated.
	 *       </td>
	 *    </tr>
	 *    <tr>
	 *       <td>actionPayload</td>
	 *       <td>A JSON block that specifies the action to be taken when trigger is activated.</td>
	 *    </tr>
	 * </table>
	 * 
	 * @methodOf WL.Server#
	 * 
	 */
	this.getBeaconsAndTriggers = function(applicationName, beaconsOfInterest) {};
};
