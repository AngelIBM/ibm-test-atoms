...
/* JavaScript content from js/controllers/category/function.js in folder common */
	...
	function init_category(){
		...
		$.when(get_Data(challenges_Json)).then(function(challenge_data){display_categoryData(challenge_data)});
	...
	function display_categoryData(category_data){
		...
		for(var i=0;i<category_data.length;i++){
			...
			category_buffer=category_buffer+
						  '<div class="Margin"><span class="MainText2">'+category_data[i].Description+'</span></div>'+
